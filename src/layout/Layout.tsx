...
const Layout = () => {
  ...
  const listPage = location.pathname === '/listing'


  const heroSection = listPage ?

    <div className="h-[53.25rem] md:h-[40rem] w-full bg-center flex flex-col items-center justify-center space-y-6 bg-no-repeat bg-cover" style={{ backgroundImage: 'url(/bg-full-2.svg)' }}></div>
    :
