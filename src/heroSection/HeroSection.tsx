const HeroSection = () => {
  return (
    <div className="h-[40rem] w-full bg-center flex flex-col items-center justify-center space-y-6" style={{backgroundImage: 'url(/hero-section-bg.svg)'}}>
      <p className="text-[1.1rem] font-medium text-[#FFFFFF] leading-[1.7rem] font-poppins">More than <span className="text-[#EE0020] ">500+</span>house available for sell & rent in country</p>
      <h1 className="leading-[4.7rem] font-bold text-[3.1rem] text-[#FFFFFF] font-poppins tracking-17p">FIND YOUR <span className="text-[#EE0020]">DREAM</span> HOME</h1>
      <div>
        <button className="rounded h-[3.9rem] w-[7.4rem] bg-[#EE0020] text-[#FFFFFF] font-medium leading-[2.1rem] text-[1.4rem]">Buy</button><button className="rounded h-[3.9rem] w-[7.4rem] bg-[#FFFFFF] text-[#000000] font-medium leading-[2.1rem] text-[1.4rem] ml-[1rem]">Rent</button>
      </div>
      <form className="p-6 space-x-4 bg-[#ffff] rounded">
