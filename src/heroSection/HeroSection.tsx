const HeroSection = () => {
  return (
    <div className="h-[53.25rem] md:h-[40rem] w-full bg-center flex flex-col items-center justify-center space-y-6" style={{ backgroundImage: 'url(/hero-section-bg.svg)' }}>
