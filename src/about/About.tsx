...
const About = () => {
  return (
    <div className="w-full flex items-center bg-[#F8F7FC] flex-col ">
      <div className="w-[90%] flex my-[4rem] justify-between">
        <div className="shrink-0 space-y-[4rem]">
          <div className="flex items-center text-[#EE0020] text-[1.3rem] font-semibold leading-[1.9rem] font-poppins"><ImHome3 /> <p>About GrandBrixx Properties Limited</p></div>
          <img src={aboutHero} alt="" className="w-[37.5rem] h-[28.18625rem]" />
        </div>
        <div className="flex flex-col justify-center w-[37.5rem]">
          <p className="font-poppins text-[2.25rem] font-semibold leading-[3.375rem] text-[#EE0020]">Property Selling</p>
          <p className="font-poppins text-[1.25rem] font-normal leading-[3.125rem] text-[#000000]">we specialize in Real Estate Services, including short-term rentals, letting, leasing, and sales. Whether you’re looking for a place to stay temporarily or a long-term rental, we can help you find the perfect property. We have a variety of options available to suit different budgets and preferences.</p>
      ...
      <section className="w-full h-[44.8rem] flex justify-center bg-center bg-no-repeat items-center relative" style={{ backgroundImage: 'url(/bg-full-2.svg)', backgroundSize: 'cover' }}>
        <div className="w-[90%] space-y-8">
          ...
          <h1 className="font-poppins text-[#000] font-semibold text-[2.5rem] leading-[3.8rem]">What We have To Offer</h1>
          <div className="flex overflow-auto no-scrollbar">
            {
              whatOffer.map((offer, index) => (
                <div key={index} className="h-[25.875rem] w-[33.25rem] mr-[3rem] shrink-0 flex flex-col justify-between p-6 bg-[#FFF] shadow-[0px_4px_4px_0px_#00000040] rounded-[0.625rem] mb-1">
                  ...
                  <p className="flex-grow mt-6 text-left font-poppins text-base font-normal leading-6 text-[#000000]">{offer.description}</p>
      ...
      <section className="w-full h-[52.6875rem] flex flex-col items-center bg-center justify-center space-y-6" style={{ backgroundImage: 'url(/bg-full-3.svg)', }}>
        ...
        <h1 className="font-poppins text-[#fff] font-semibold text-[2.5rem] leading-[3.8rem]">Cover <span className="text-[#EE0020]">Values</span></h1>
      ...
      <section className="w-full h-[48.9375rem] flex justify-center bg-center bg-no-repeat bg-cover" style={{ backgroundImage: 'url(/bg-full-4.svg)', }}>
        <main className="w-[90%] relative flex flex-col justify-center space-y-4">
          ...
          <h1 className="font-poppins text-[#000] font-semibold text-[2.5rem] leading-[3.8rem]">Meet The Team </h1>
          <div className="flex flex-wrap justify-between gap-[5rem]">
            {
              team.map((team, index) => (
                <div className="w-[30.125rem] h-[9.875rem] rounded-[0.3125rem] shadow-[0px_4px_4px_0px_#00000040] flex p-5" key={index}>
                  <div className="">
                    <img src={team.pix} alt="Team DP" className="w-[7.875rem] h-[7.125rem]" />
                  </div>
                  <div className="ml-[1.5rem] flex flex-col justify-center">
                    <h1 className="font-poppins text-[1.875rem] font-medium leading-[2.8125rem]">{team.name}</h1>
                    <p className="font-poppins text-[1.5rem] font-medium leading-[2.25rem]">{team.role}</p>
                  </div>
                </div>
              ))
            }
      ...
      <section className="w-full flex justify-center">
        <div className="w-[90%] space-y-[2rem] mb-[2rem]">
