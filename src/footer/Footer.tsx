...
const Footer:React.FC<FooterProps> = ({marginTop}) => {
  return (
    <div className='w-[100%] flex items-center bg-[#1D1F26] flex-col'>
      <div className='w-[90%] my-[2.5rem] flex justify-between flex-col md:flex-row gap-[1.5rem] md:gap-[0rem] py-6' style={{marginTop: marginTop || '0'}} >
        <div className='w-[100%] md:w-[30%] flex flex-col gap-[0.5rem] md:gap-[1.5rem]'>
